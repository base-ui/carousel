...
SlideList.prototype.removeSlideElement = function (slideElement) {
  var self = this;

  for (var i in self.items) {
    if (self.items[i].el === slideElement) {
      return self.remove(self.items[i]);
    }
  }
}
...
SlideList.prototype.appendSlide = SlideList.prototype.append;

SlideList.prototype.appendSlideElement = function (slideElement) {
  return this.appendSlide(new Slide(slideElement));
}
